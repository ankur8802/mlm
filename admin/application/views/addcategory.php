...
<!--                 <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60">
 -->              </a>
        ...
        <div class="container-fluid">
         ...
         <form action="<?= base_url('Products/instaddcategory')?>" method="post">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered text-center" id="category" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>S No.</th>
                      <th>Category Name</th>
                ...
                ?>
                   <tr>
                      ...
                      <td><?= $key->date?></td>
                      <td>
                        <a href="<?= base_url("Products/deleteaddcategory/$key->id")?>"> <i class="far fa-trash-alt" style="color:red;font-size:25px;"></i> </a>
                      </td>
