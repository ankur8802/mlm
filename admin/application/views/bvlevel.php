...
<head>
  ...
  <title>B V Level Percentage</title>
...
<!--                 <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60">
 -->              </a>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">B V Level Percentage</h1>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered text-center" id="bvlevel" width="100%" cellspacing="0">
                  ...
                  <?php
                  foreach ($bvlavel as $key) {
                  ?>
                   <tr>
                   	   <td> <?= $key->level;?></td>
                       <form action="<?= base_url('Welcomelogin/bvupdate')?>" method="post" class="form-group">
                       <td>
                         
                           <input type="text" class="form-control text-center" name="percentage" required value="<?= $key->percentage;?>">
