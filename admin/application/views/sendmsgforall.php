...
<head>
  ...
  <title>Send Message For All</title>
...
<!--                 <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60">
 -->              </a>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Send Message For All</h1>
           
         <form action="<?= base_url('Welcomelogin/instmessageforall')?>" method="post">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                   	   ...
                   	   <td><?= $key->date;?></td>
                   	   <td>
                   	   	   <a href="<?= base_url('Welcomelogin/deletemessageforall')?>/<?= $key->id;?>"> <button class="btn btn-success">Delete</button> </a>
                   	   </td>
                   </tr>
                   <?php $i++; } ?>
