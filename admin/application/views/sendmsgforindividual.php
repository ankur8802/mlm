...
<head>
  ...
  <title>Send Message Individual Member</title>
...
<!--                 <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60">
 -->              </a>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Send Message Individual Member</h1>
           
         <form action="<?= base_url('Welcomelogin/instsendmsgforindividual')?>" method="post">
            <div class="row form-group">
              ...
              <div class="col-md-12" style="margin-bottom:20px;">
                ...
                <select class="form-control" name="userid" required>
                     ...
                     ?>
                     <option><?= $key->your_sponsor_id?></option>
                     <?php
                   }
                   ?>
                </select>
              ...
              <div class="col-md-12">
                <textarea name='message' placeholder="Enter Message....." rows="3" class="form-control" required></textarea>
              </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                   	   ...
                   	   <td><?= $key->date;?></td>
                   	   <td>
                   	   	   <a href="<?= base_url('Welcomelogin/deletesendmsgforindividual')?>/<?= $key->id;?>"> <button class="btn btn-success">Delete</button> </a>
                   	   </td>
                   </tr>
                   <?php $i++; } ?>
