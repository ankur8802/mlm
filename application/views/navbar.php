		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="<?= base_url("Welcome/gallery")?>" class="nav-link">Gallery</a></li>
					...
					<li class="nav-item"><a href="<?= base_url("Welcome/contactus")?>" class="nav-link">Contact Us</a></li>

					<li class="nav-item"><a href="<?= base_url('login')?>" class="nav-link btn-primary btn">Login</a></li>
