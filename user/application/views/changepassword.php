 ...
 -->              </a>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="">
                <form action="<?= base_url('Welcomelogin/updatepassword')?>" class="row form-group" method="post">
            ...
            <div class="col-md-4 text-center" style="margin-top:10px;">
              ...
              <input type="password" name="newpassword" class="form-control" placeholder="Enter Old Password..." required="">
            </div>
            ...
            <div class="col-md-4 text-center" style="margin-top:10px;">
              ...
              <input type="password" name="cnewpassword" class="form-control" placeholder="Enter Old Password..." required="">
            </div>
