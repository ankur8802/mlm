...
<head>
  ...
  <title>Message For Individual</title>
...
<!--                 <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60">
 -->              </a>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Message For Individual</h1>
...
?>
      <div class="col-md-4 text-center">
            <div class="box" style="box-shadow: 0px 0px 10px #C5B358;text-align: justify;padding:10px;">
              <?= $key->message?>
            </div>
      </div>
<?php
